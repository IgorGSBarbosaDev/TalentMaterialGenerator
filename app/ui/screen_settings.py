...
class SettingsScreen(QWidget):
    ...
    def __init__(self, config: dict) -> None:
        ...
        form.addRow("Planilha local padrão", self.default_spreadsheet)
        form.addRow("Link padrão OneDrive", self.default_onedrive)
        form.addRow("Pasta de saída padrão", self.default_output)
        ...
        button_row.addWidget(btn_theme)
